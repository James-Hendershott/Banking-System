...
const dbConfig = require('./lib/connectionInfo');
...
function createTables() {
    ...
    const createBankAccountsTable = `
        CREATE TABLE IF NOT EXISTS bank_accounts (
            ...
            account_type VARCHAR(50) NOT NULL, -- 'savings' or 'checking'
...
function createStoredProcedures() {
    ...
    const changeUserType = `
        ...
        BEGIN
            UPDATE users
            SET user_role_id = (SELECT id FROM user_roles WHERE type = new_role)
