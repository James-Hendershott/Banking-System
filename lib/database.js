    ...
    const registerUser = `
        ...
        BEGIN
            ...
            IF userCount = 0 THEN
                ...
                VALUES (
                    in_username, in_hashed_password, in_salt, in_first_name, in_last_name, in_email, 
...
con.query(insertRoles, handleDummyData('Roles'));
    ...
    `;
    con.query(insertEmployee, handleDummyData('Employee user'));
    ...
    `;
    con.query(insertCustomer, handleDummyData('Customer user'));
}
